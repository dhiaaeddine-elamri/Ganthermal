...
base_sample_dir = 'new_samples'
comparison_dir = os.path.join(base_sample_dir, 'comparison')
generated_dir = os.path.join(base_sample_dir, 'generated')
denoised_dir = os.path.join(base_sample_dir, 'denoised')
os.makedirs(comparison_dir, exist_ok=True)
os.makedirs(generated_dir, exist_ok=True)
os.makedirs(denoised_dir, exist_ok=True)

if not os.path.exists('C:/Users/dhiaa/Desktop/project5/saved_weights_new'):
    os.makedirs('C:/Users/dhiaa/Desktop/project5/saved_weights_new')
...
for epoch in range(0, 200):
    ...
    with torch.no_grad():
        ...
        save_image(comparison, f'{comparison_dir}/comparison_epoch_{epoch+1:03d}.png', normalize=True, nrow=1)
        save_image(fixed_fake, f'{generated_dir}/generated_epoch_{epoch+1:03d}.png', normalize=True)
        save_image(fixed_denoised, f'{denoised_dir}/denoised_epoch_{epoch+1:03d}.png', normalize=True)
    ...
    # Save model weights at the end of each epoch in a new folder
    torch.save(generator_model.state_dict(), f'C:/Users/dhiaa/Desktop/project5/saved_weights_new/generator_epoch_{epoch+1}.pth')
    torch.save(denoising_model.state_dict(), f'C:/Users/dhiaa/Desktop/project5/saved_weights_new/denoiser_epoch_{epoch+1}.pth')
    torch.save(global_discriminator1.state_dict(), f'C:/Users/dhiaa/Desktop/project5/saved_weights_new/global_discriminator1_epoch_{epoch+1}.pth')
    torch.save(global_discriminator2.state_dict(), f'C:/Users/dhiaa/Desktop/project5/saved_weights_new/global_discriminator2_epoch_{epoch+1}.pth')
    torch.save(local_discriminator.state_dict(), f'C:/Users/dhiaa/Desktop/project5/saved_weights_new/local_discriminator_epoch_{epoch+1}.pth')
...
print("\nSaved files:")
print("- Generated images per epoch: new_samples/generated/generated_epoch_XXX.png")
print("- Denoised images per epoch: new_samples/denoised/denoised_epoch_XXX.png")
print("- Comparison images per epoch: new_samples/comparison/comparison_epoch_XXX.png")  